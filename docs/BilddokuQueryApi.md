...
[**delete_bilddoku_by_point**](BilddokuQueryApi.md#delete_bilddoku_by_point) | **DELETE** /bilddoku/query/{bilddoku_query_id} | delete Bilddoku for given point
[**get_bilddoku_by_point**](BilddokuQueryApi.md#get_bilddoku_by_point) | **GET** /bilddoku/query/{bilddoku_query_id} | get Bilddoku for given point
...
# **delete_bilddoku_by_point**
> delete_bilddoku_by_point(bilddoku_query_id)
...
try:
    # delete Bilddoku for given point
    api_instance.delete_bilddoku_by_point(bilddoku_query_id)
except ApiException as e:
    print("Exception when calling BilddokuQueryApi->delete_bilddoku_by_point: %s\n" % e)
```
...
# **get_bilddoku_by_point**
> BilddokuQuery get_bilddoku_by_point(bilddoku_query_id)
...
try:
    # get Bilddoku for given point
    api_response = api_instance.get_bilddoku_by_point(bilddoku_query_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling BilddokuQueryApi->get_bilddoku_by_point: %s\n" % e)
```
