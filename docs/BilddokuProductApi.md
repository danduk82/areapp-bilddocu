...
> post_bilddoku_product(body=body)
...
# create an instance of the API class
api_instance = swagger_client.BilddokuProductApi(swagger_client.ApiClient(configuration))
body = swagger_client.BilddokuProduct() # BilddokuProduct |  (optional)

try:
    # add new product for a given bilddoku query
    api_instance.post_bilddoku_product(body=body)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**BilddokuProduct**](BilddokuProduct.md)|  | [optional] 
...
> put_bilddoku_product(bilddoku_product_id, body=body)
...
try:
    # add new product for a given bilddoku query
    api_instance.put_bilddoku_product(bilddoku_product_id, body=body)
except ApiException as e:
