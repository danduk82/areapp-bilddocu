...
class BilddokuQuery(object):
    ...
    def __init__(self, api_version=None, id=None, point_id=None, swissname=None, gemeinde=None, specific_remark=None, type_classifications=None, canceled=False):  # noqa: E501
